...
{
 "use strict";
 var Global,hw1try232143124213,Client,WebSharper,Obj,UI,Var$1,Var,Operators,Error,MatchFailureException,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,Unchecked,hw1try232143124213_Templates,ConcreteVar,Snap,System,Guid,Collections,List,Client$1,Templates,Doc,JavaScript,Pervasives,Abbrev,Fresh,Dictionary,Object,HashSet,Seq,TemplateInitializer,EventTarget,Node,JS,View,Numeric,AttrProxy,CheckedInput,DictionaryUtil,Enumerator,T,SC$1,WindowOrWorkerGlobalScope,Docs,SC$2,DocElemNode,CharacterData,Elt,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,AttrModule,List$1,T$1,Strings,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,HashSetUtil,BindVar,SC$4,SC$5,AppendList,SC$6,DynamicAttrNode,Scheduler,Easing,AsyncBody,SC$7,CT,HashSet$1,String,CancellationTokenSource,DomNodes,Char,OperationCanceledException,Lazy,SC$8,Queue,LazyExtensionsProxy,LazyRecord,Math,IntelliFactory,Runtime$1,console,Date;
 Global=self;
 hw1try232143124213=Global.hw1try232143124213=Global.hw1try232143124213||{};
 Client=hw1try232143124213.Client=hw1try232143124213.Client||{};
 ...
 hw1try232143124213_Templates=Global.hw1try232143124213_Templates=Global.hw1try232143124213_Templates||{};
 ...
 {
  var num1,num2,operator,disp,a,b,t,t$1,t$2,t$3,t$4,t$5,t$6,t$7,t$8,t$9,t$10,t$11,t$12,t$13,t$14,t$15,t$16,t$17,t$18,t$19,t$20,_this,p,i;
  function Calc(op,n1,n2,n3)
  {
   var c,c$1,c$2,c$3,c$4,c$5,c$6,m;
   m=op.Get();
   if(m==="+")
    n3.Set((c=n1+Global.Number(n2.Get()),Global.String(c)));
   else
    if(m==="-")
     n3.Set((c$1=Global.Number(n2.Get())-n1,Global.String(c$1)));
    else
     if(m==="*")
      n3.Set((c$2=n1*Global.Number(n2.Get()),Global.String(c$2)));
     else
      if(m==="/")
       n1===0?n3.Set("E"):n3.Set((c$3=Global.Number(n2.Get())/n1,Global.String(c$3)));
      else
       if(m==="1/")
        n2.Set((c$4=1/Global.Number(n2.Get()),Global.String(c$4)));
       else
        if(m==="sin")
         n2.Set((c$5=Math.sin(Global.Number(n2.Get())),Global.String(c$5)));
        else
         if(m==="cos")
  ...
  num1=Var$1.Create$1("");
  num2=Var$1.Create$1("");
  operator=Var$1.Create$1("");
  disp=Var$1.Create$1("");
  a=(b=(t=(t$1=(t$2=(t$3=(t$4=(t$5=(t$6=(t$7=(t$8=(t$9=(t$10=(t$11=(t$12=(t$13=(t$14=(t$15=(t$16=(t$17=(t$18=(t$19=(t$20=(_this=new ProviderBuilder.New$1(),(_this.h.push({
   $:8,
   $0:"result",
   $1:disp
  }),_this)),(t$20.h.push(Handler.EventQ2(t$20.k,"zero",function()
  {
   return t$20.i;
  },function()
  {
   if(operator.Get()!=="")
    {
     ...
     num2.Get()==="E"?(Clearnum1(),Clearnum2(),Clearop(),Cleardisp(),disp.Set("E")):disp.Set("0");
    }
   else
    {
     num1.Set("0");
  ...
  })),t$20)),(t$19.h.push(Handler.EventQ2(t$19.k,"one",function()
  {
   return t$19.i;
  },function()
  {
  ...
  })),t$19)),(t$18.h.push(Handler.EventQ2(t$18.k,"two",function()
  {
   return t$18.i;
  },function()
  {
  ...
  })),t$18)),(t$17.h.push(Handler.EventQ2(t$17.k,"three",function()
  {
   return t$17.i;
  },function()
  {
  ...
  })),t$17)),(t$16.h.push(Handler.EventQ2(t$16.k,"four",function()
  {
   return t$16.i;
  },function()
  {
  ...
  })),t$16)),(t$15.h.push(Handler.EventQ2(t$15.k,"five",function()
  {
   return t$15.i;
  },function()
  {
  ...
  })),t$15)),(t$14.h.push(Handler.EventQ2(t$14.k,"six",function()
  {
   return t$14.i;
  },function()
  {
  ...
  })),t$14)),(t$13.h.push(Handler.EventQ2(t$13.k,"seven",function()
  {
   return t$13.i;
  },function()
  {
  ...
  })),t$13)),(t$12.h.push(Handler.EventQ2(t$12.k,"eight",function()
  {
   return t$12.i;
  },function()
  {
  ...
  })),t$12)),(t$11.h.push(Handler.EventQ2(t$11.k,"nine",function()
  {
   return t$11.i;
  },function()
  {
  ...
  })),t$11)),(t$10.h.push(Handler.EventQ2(t$10.k,"add",function()
  {
   return t$10.i;
  },function()
  {
   if(operator.Get()!=="")
    ...
    operator.Set("+");
  })),t$10)),(t$9.h.push(Handler.EventQ2(t$9.k,"neg",function()
  {
   return t$9.i;
  },function()
  {
   ...
   if(operator.Get()!=="")
    {
     num2.Set(num1.Get());
     num2.Set((c=-Global.Number(num2.Get()),Global.String(c)));
     disp.Set(num2.Get());
     num1.Set(num2.Get());
     operator.Set("+-");
    }
    ...
    {
     num1.Set((c$1=-Global.Number(num1.Get()),Global.String(c$1)));
     disp.Set(num1.Get());
     operator.Set("+-");
    }
  })),t$9)),(t$8.h.push(Handler.EventQ2(t$8.k,"sub",function()
  {
   return t$8.i;
  },function()
  {
   if(operator.Get()!=="")
    ...
    operator.Set("-");
  })),t$8)),(t$7.h.push(Handler.EventQ2(t$7.k,"mult",function()
  {
   return t$7.i;
  },function()
  {
   if(operator.Get()!=="")
    ...
    operator.Set("*");
  })),t$7)),(t$6.h.push(Handler.EventQ2(t$6.k,"div",function()
  {
   return t$6.i;
  },function()
  {
   if(operator.Get()!=="")
    ...
    operator.Set("/");
  })),t$6)),(t$5.h.push(Handler.EventQ2(t$5.k,"c",function()
  {
   return t$5.i;
  },function()
  {
   Cleardisp();
  })),t$5)),(t$4.h.push(Handler.EventQ2(t$4.k,"ac",function()
  {
   return t$4.i;
  },function()
  {
   ...
   Clearop();
   Cleardisp();
  })),t$4)),(t$3.h.push(Handler.EventQ2(t$3.k,"equ",function()
  {
   return t$3.i;
  },function()
  {
  ...
  })),t$1)),(t.h.push(Handler.EventQ2(t.k,"flip",function()
  {
   return t.i;
  },function()
  {
  ...
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["result",0]]),(i=new TemplateInstance.New(p[1],hw1try232143124213_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 hw1try232143124213_Templates.main=function(h)
 {
